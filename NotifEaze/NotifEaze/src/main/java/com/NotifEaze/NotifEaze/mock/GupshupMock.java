...
public class GupshupMock {
	...
	public BasePushNotificationResponse sendPushNotification(String fcmToken, String message) {
	...
	public SmsDeliveryStatus checkSmsDeliveryStatus(String messageId) {
		// TODO Auto-generated method stub
		return null;
	}
}
